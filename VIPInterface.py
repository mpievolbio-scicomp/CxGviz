...
def LI(data):
    ...
    return '<iframe src="https://evolomero.evolbio.mpg.de/webclient/search?search_query={0:s}" id="omeroviewport" name="omeroviewport" width=100% height=600></iframe>'.format("%20AND%20".join(["Gene:"+gn for gn in gene_names]))
